	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'bf':
				...
				animation.addByPrefix('meow', 'BF HEY', 24, false);
			...
			case 'kapi':
				...
				playAnim('idle');
			case 'kapi-mad':
				tex = Paths.getSparrowAtlas('characters/KAPI_ANGRY', 'shared');
				frames = tex;
				animation.addByIndices('idle', 'Dad idle dance', [2, 4, 6, 8, 10, 0], "", 12, false);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24, false);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24, false);
			...
			case 'game-and-watch':
				...
				frames = tex;
				animation.addByIndices('idle', 'spooky dance idle', [8, 10, 12, 14], "", 12, false);
